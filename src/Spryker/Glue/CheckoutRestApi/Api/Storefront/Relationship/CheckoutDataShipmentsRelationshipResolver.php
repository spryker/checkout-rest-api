...
{
    protected const string RELATIONSHIP_DATA_PROPERTY = 'shipmentsRelationshipData';
    ...
    protected function resolveRelationship(): array
    {
        ...
        foreach ($this->getParentResources() as $parent) {
            ...
            foreach ($parent->{static::RELATIONSHIP_DATA_PROPERTY} ?? [] as $row) {
                $resources[] = $this->serializer->denormalize($row, ShipmentsStorefrontResource::class);
            }
        }
